...
export default class Garden extends Component {
  ...
  initializePlants = async () => {
    if (this.state.plantsInitialized == true) {
      return;
    }
    this.setState({ plantsInitialized: true });
    let commons1 = JSON.parse(await SecureStore.getItemAsync("commons1"));
    let commons2 = JSON.parse(await SecureStore.getItemAsync("commons2"));
